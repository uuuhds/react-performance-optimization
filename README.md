...
<img src="./public/images/2.maximumUpdate.png"/>
...
5. 生产环境下的三种 JS 文件
   ...
   3. runtime~main.[hash].js webpack运行时代码
         ...
         <img src="./public/images/5-1-未加入lodash时的初始包大小.png" align="left" width="50%"/>

         <img src="./public/images/5-2-加入lodash后的包大小.png" align="left" width="50%"/>

         <img src="./public/images/5-3-优化lodash后的包大小.png" align="left" width="50%"/>
